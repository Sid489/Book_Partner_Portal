...
public class PublisherServiceImpl implements PublisherService {
    ...
    private final IPublisherRepo publisherRepository;

    public PublisherServiceImpl(IEmployeeRepo employeeRepository, IPublisherRepo publisherRepository) {
    ...
    public PublisherEmployeeResponseDTO getEmployeesWithJobs(String pubId) {
        ...
        Publishers publisher = publisherRepository.findById(pubId).orElseThrow(() -> new ResourceNotFoundException("Publisher not found with id: " + pubId));
        List<Employee> e = employeeRepository.findEmployeesWithJobsByPublisherId(pubId);
    ...
    public List<TopPublisherDTO> getTopPerformingPublishers() {
        return publisherRepository.findTopPerformingPublishers();
    }
